...
inherit check-reqs chromium-2 eutils gnome2-utils flag-o-matic git-r3  multilib multiprocessing pax-utils portability python-any-r1 readme.gentoo-r1 toolchain-funcs versionator virtualx xdg-utils
...
if false; then #prior to code review old
	...
	einfo "Generating v8 x32 code..."
	cp {v8-remote,v8}/tools/generate-x64-patch.sh
	cp {v8-remote,v8}/tools/generate-x64-sources.py
	pushd ./v8
	./tools/generate-x64-patch.sh
	FILES="./src/crankshaft/x32/lithium-codegen-x32.h ./src/crankshaft/x32/lithium-gap-resolver-x32.h ./src/crankshaft/x32/lithium-x32.h ./src/x32/assembler-x32-inl.h ./src/x32/assembler-x32.h ./src/x32/code-stubs-x32.h ./src/x32/codegen-x32.h ./src/x32/frames-x32.h ./src/x32/macro-assembler-x32.h ./src/regexp/x32/regexp-macro-assembler-x32.h ./src/compiler/x32/instruction-codes-x32.h"
	for f in $FILES; do
		sed -i 's|/x64/|/x32/|g' "$f"
		sed -i 's|-x64|-x32|g' "$f"
	done
	FILES="./src/crankshaft/x32/lithium-codegen-x32.cc ./src/crankshaft/x32/lithium-gap-resolver-x32.cc ./src/crankshaft/x32/lithium-x32.cc ./src/x32/assembler-x32.cc ./src/x32/builtins-x32.cc ./src/x32/code-stubs-x32.cc ./src/x32/codegen-x32.cc ./src/x32/cpu-x32.cc ./src/x32/deoptimizer-x32.cc ./src/x32/disasm-x32.cc ./src/x32/frames-x32.cc ./src/x32/interface-descriptors-x32.cc ./src/x32/macro-assembler-x32.cc ./src/debug/x32/debug-x32.cc ./src/full-codegen/x32/full-codegen-x32.cc ./src/ic/x32/access-compiler-x32.cc ./src/ic/x32/handler-compiler-x32.cc ./src/ic/x32/ic-x32.cc ./src/ic/x32/ic-compiler-x32.cc ./src/ic/x32/stub-cache-x32.cc ./src/regexp/x32/regexp-macro-assembler-x32.cc ./src/compiler/x32/code-generator-x32.cc ./src/compiler/x32/instruction-scheduler-x32.cc ./src/compiler/x32/instruction-selector-x32.cc"
	for f in $FILES; do
		sed -i 's|/x64/|/x32/|g' "$f"
		sed -i 's|-x64|-x32|g' "$f"
	done
...
src_configure() {
	...
	#muslx32
	[[ -n "${target_arch_abi}" ]] && myconf_gyp+=" -Dtarget_arch_abi=${target_arch_abi}"
	[[ -n "${target_cpu_abi}" ]] && myconf_gyp+=" -Dtarget_cpu_abi=${target_cpu_abi}"

...
src_prepare() {
	...
	if use abi_x86_x32; then
		...
		epatch "${FILESDIR}"/${PN}-45.2.0-linux_syscall_support_h-x32.patch
		epatch "${FILESDIR}"/${PN}-45.2.0-stat-x32.patch
		#epatch "${FILESDIR}"/${PN}-45.2.0-libav-asflags.patch
		...
		#epatch "${FILESDIR}"/${PN}-45.2.0-jit-x32-1.patch #disabled #have 64 punbox64
		epatch "${FILESDIR}"/${PN}-45.2.0-jit-x32-2.patch #asm padding
		#epatch "${FILESDIR}"/${PN}-45.2.0-jit-x32-3.patch
	fi

...
src_prepare() {
	...
	if use abi_x86_x32; then
		...
		#epatch "${FILESDIR}"/${PN}-45.2.0-disable-jpegturbo-optimizations-on-x32.patch
		epatch "${FILESDIR}"/${PN}-45.2.0-sysdef.patch
		#epatch "${FILESDIR}"/${PN}-45.2.0-linux_syscall_support_h-x32.patch #checking
		...
		#epatch "${FILESDIR}"/${PN}-45.2.0-x32-structs64.patch #test
		epatch "${FILESDIR}"/${PN}-47.0.1-fstat-missing.patch
		epatch "${FILESDIR}"/${PN}-47.0.1-stat64-x32.patch

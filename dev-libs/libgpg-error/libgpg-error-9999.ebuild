...
inherit eutils libtool multilib-minimal toolchain-funcs git-r3 autotools
...
src_unpack() {
	EGIT_REPO_URI="https://github.com/gpg/libgpg-error.git"
	git-r3_fetch
	git-r3_checkout
}

src_prepare() {
	epatch "${FILESDIR}"/libgpg-error.patch
	epatch_user
	elibtoolize
	eautoreconf
	cp src/syscfg/lock-obj-pub.x86_64-pc-linux-musl.h src/syscfg/lock-obj-pub.x86_64-pc-linux-muslx32.h || die "failed"
}

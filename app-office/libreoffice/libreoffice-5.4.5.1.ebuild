...
COMMON_DEPEND="${PYTHON_DEPS}
	...
	app-crypt/gpgme[cxx]
	app-text/hunspell:=
	>=app-text/libabw-0.1.0[${MULTILIB_USEDEP}]
	>=app-text/libebook-0.1[${MULTILIB_USEDEP}]
	>=app-text/libetonyek-0.1[${MULTILIB_USEDEP}]
	app-text/libexttextcat[${MULTILIB_USEDEP}]
	app-text/liblangtag[${MULTILIB_USEDEP}]
	>=app-text/libmspub-0.1.0[${MULTILIB_USEDEP}]
	>=app-text/libmwaw-0.3.1[${MULTILIB_USEDEP}]
	>=app-text/libodfgen-0.1.0[${MULTILIB_USEDEP}]
	app-text/libstaroffice[${MULTILIB_USEDEP}]
	app-text/libwpd:0.10[tools,${MULTILIB_USEDEP}]
	app-text/libwpg:0.3[${MULTILIB_USEDEP}]
	>=app-text/libwps-0.4[${MULTILIB_USEDEP}]
	app-text/mythes
	...
	dev-libs/libassuan[${MULTILIB_USEDEP}]
	dev-libs/libgpg-error[${MULTILIB_USEDEP}]
	=dev-libs/liborcus-0.12*[${MULTILIB_USEDEP}]
	dev-libs/librevenge[${MULTILIB_USEDEP}]
	dev-libs/nspr[${MULTILIB_USEDEP}]
	dev-libs/nss[${MULTILIB_USEDEP}]
	!libressl? ( >=dev-libs/openssl-1.0.0d:0[${MULTILIB_USEDEP}] )
	libressl? ( dev-libs/libressl[${MULTILIB_USEDEP}] )
	>=dev-libs/redland-1.0.16[${MULTILIB_USEDEP}]
	>=dev-libs/xmlsec-1.2.24[nss,${MULTILIB_USEDEP}]
	media-gfx/graphite2
	media-libs/fontconfig[${MULTILIB_USEDEP}]
	media-libs/freetype:2[${MULTILIB_USEDEP}]
	>=media-libs/harfbuzz-0.9.42:=[graphite,icu,${MULTILIB_USEDEP}]
	media-libs/lcms:2[${MULTILIB_USEDEP}]
	>=media-libs/libcdr-0.1.0[${MULTILIB_USEDEP}]
	>=media-libs/libepoxy-1.3.1[X,${MULTILIB_USEDEP}]
	>=media-libs/libfreehand-0.1.0[${MULTILIB_USEDEP}]
	media-libs/libpagemaker[${MULTILIB_USEDEP}]
	>=media-libs/libpng-1.4:0=[${MULTILIB_USEDEP}]
	>=media-libs/libvisio-0.1.0[${MULTILIB_USEDEP}]
	media-libs/libzmf[${MULTILIB_USEDEP}]
	net-libs/neon[${MULTILIB_USEDEP}]
	net-misc/curl
	net-nds/openldap
	...
	coinmp? ( sci-libs/coinor-mp[${MULTILIB_USEDEP}] )
	collada? ( media-libs/opencollada[${MULTILIB_USEDEP}] )
	cups? ( net-print/cups )
	dbus? ( dev-libs/dbus-glib[${MULTILIB_USEDEP}] )
	eds? (
	...
	gltf? ( >=media-libs/libgltf-0.1.0[${MULTILIB_USEDEP}] )
	gstreamer? (
	...
	gtk3? (
		dev-libs/glib:2[${MULTILIB_USEDEP}]
		dev-libs/gobject-introspection[${MULTILIB_USEDEP}]
		gnome-base/dconf
	...
	kde? (
		...
		kde-frameworks/kdelibs[${MULTILIB_USEDEP}]
	)
...
DEPEND="${COMMON_DEPEND}
	!<sys-devel/make-3.82
	>=dev-libs/libatomic_ops-7.2d[${MULTILIB_USEDEP}]
	>=dev-libs/libxml2-2.7.8[${MULTILIB_USEDEP}]

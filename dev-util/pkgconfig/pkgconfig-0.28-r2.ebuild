...
inherit eutils flag-o-matic libtool multilib multilib-minimal autotools
...
src_prepare() {
	...
	epatch "${FILESDIR}"/pkgconfig-0.28-r2-musl1.patch
	epatch "${FILESDIR}"/pkgconfig-0.28-r2-musl2.patch

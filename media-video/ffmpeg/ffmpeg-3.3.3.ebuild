...
src_prepare() {
	...
	if [[ "${CHOST}" =~ "muslx32" ]] ; then
		if use experimental ; then
			...
			epatch "${FILESDIR}"/02-14-3.2.4-x32-inline-asm-fix-asm.h.patch
			epatch "${FILESDIR}"/03-14-3.2.4-x32-inline-asm-fix-cpudetection.patch
			epatch "${FILESDIR}"/04-14-3.2.4-x32-inline-asm-fix-push-pop-indirect-jmp.patch #missing some parts
			epatch "${FILESDIR}"/05-14-3.2.4-x32-inline-asm-fix-cabac.patch
			epatch "${FILESDIR}"/06-14-3.2.4-x32-yasm-x86inc-add-ptrsize-and-p-suffix.patch
			...
			epatch "${FILESDIR}"/15-14-3.2.4-x32-yasm-audio_convert_asm-fix-ptr-usage.patch
			epatch "${FILESDIR}"/16-14-x32-yasm-flacdsp_asm-fix-ptr-usage.patch
			epatch "${FILESDIR}"/${PN}-3.2.4-x32-resample_asm-ptr-usage.patch
			epatch "${FILESDIR}"/17-x32-3.3.3-inline-swscale_template_c.patch
		fi
	fi

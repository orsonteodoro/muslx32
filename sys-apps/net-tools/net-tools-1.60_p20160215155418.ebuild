...
DEPEND="${RDEPEND}
	...
	app-arch/xz-utils
	sys-kernel/linux-headers" #line added by muslx32 overlay
if [[ ${PV} == "9999" ]]; then
...
src_prepare() {
	...
	epatch "${FILESDIR}/${PN}-1.60_p20161110235919-fix-building-w-older-linux-headers.patch"
	epatch "${FILESDIR}/${PN}-1.60_p20160215155418-redefinition-struct-iphdr.patch"
}

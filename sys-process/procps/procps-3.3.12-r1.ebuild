...
inherit epatch toolchain-funcs flag-o-matic \
	autotools # added by muslx32 overlay
...
src_prepare() {
	...
	if [[ "${CHOST}" =~ "muslx32" ]] ; then
		#disable makefile generation in the compile stage because we want to keep the patches generated by the bashrc
		epatch "${FILESDIR}/procps-3.3.12-disable-makefile-gen.patch"

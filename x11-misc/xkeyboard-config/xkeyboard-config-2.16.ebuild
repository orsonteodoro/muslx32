...
XORG_STATIC=no
XORG_EAUTORECONF=no
inherit xorg-2 flag-o-matic toolchain-funcs autotools
...
src_configure() {
	append-cflags -I/usr/lib/gcc/${CHOST}/$(gcc-fullversion)/ -I/usr/include -I/usr/include/${CHOST} -I/usr/share/gettext/intl
	append-cppflags -I/usr/lib/gcc/${CHOST}/$(gcc-fullversion)/ -I/usr/include -I/usr/include/${CHOST} -I/usr/share/gettext/intl

...
inherit bash-completion-r1 eutils multilib multilib-minimal pax-utils flag-o-matic
...
src_prepare() {
	...
	epatch "${FILESDIR}"/${PN}-1.6.3-musl2.patch
	epatch "${FILESDIR}"/${PN}-1.6.3-musl3.patch
}
...
multilib_src_configure() {
	append-cppflags -I${WORKDIR}/${PN}-${PV}/win32/common/ -D__STRICT_ANSI__ -D_XOPEN_SOURCE
#	append-cppflags -I${WORKDIR}/${PN}-${PV}/win32/common/ -I/usr/include/bits/ -D__STRICT_ANSI__
